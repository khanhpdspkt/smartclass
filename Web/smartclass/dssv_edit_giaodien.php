...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Thay đổi danh sách sinh viên
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.html"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="#">Thay đổi danh sách sinh viên</a></li>
      </ol>
    </section>
...
<h3 class="box-title">Thay đổi danh sách sinh viên</h3>
</div>
<!-- /.box-header -->
<div class="box-body">
...
<!-- /.content -->
  ...
  <footer class="main-footer">
    ...
    <div class="pull-right hidden-xs">
      Truong Chi Dung & Le Quoc Khanh
    </div>
    <!-- Default to the left -->
    <strong>Do an 2 <a href="#">Smart Class</a></strong>
  </footer>
